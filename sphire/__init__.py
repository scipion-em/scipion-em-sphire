...
class Plugin(pwem.Plugin):
    ...
    def defineBinaries(cls, env):
        ...
        cls.addCryoloPackage(env, V1_8_1, default=False, pythonVersion='3.7')
        cls.addCryoloPackage(env, V1_8_1, default=False, pythonVersion='3.7', useCpu=True)
